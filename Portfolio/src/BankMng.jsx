  ...
  return (
   <section className='h-[200%]  bg-gradient-to-r from-slate-950 to-slate-900  md:w-[94%] w-[85%]  md:ml-5 md:mt-4'>
     ...
     <h1 className=' hidden md:text-white text-3xl md:flex justify-center relative top-9'>Project Name: Bank Management System</h1>
            <h1 className=' block  text-white text-lg text-center relative top-9 md:hidden'>Project Name: Bank Management System</h1>
            ...
            <div className="flex-col h-44 md:ml-5 ml-1 p-2 md:h-44 md:w-80 w-72 bg-slate-100 rounded-xl border-lime-200 mt-7 bg-[url('https://tse3.mm.bing.net/th?id=OIP.8VvfJswchA29Zk6fc7RZhwHaEG&pid=Api&P=0&h=180')] bg-cover hover:border-4 "></div>
            <div className="  flex-col h-44 md:-5 ml-1 p-2 md:h-44 md:w-80 w-72 bg-slate-100 rounded-xl border-lime-200 mt-7 md:ml-10 bg-[url('https://tse1.mm.bing.net/th?id=OIP.z9bb9ZdauvEfoEx3P_yVPgHaEK&pid=Api&P=0&h=180')] bg-cover hover:border-4 "></div></div>
            </div>
